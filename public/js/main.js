...
$('.moreButton').on('click', function () {
    ...
    $.ajax({
        url: action, data: requestData, success: result => {
...
$('.comment-reply').on('click', function () {
    ...
    replyBlock
        .find('.panel-body').text(commentText).end()
        .find('.reply-user').text(userName).end()
...
$('.close-reply').on('click', function () {
    ...
    $('.reply-block')
        .addClass('hidden')
        .find('.panel-body').text('').end()
        .find('.reply-user').text('').end()
    ;
...
$('.likes-block .action-btn').on('click', function () {
    ...
    $.ajax({
        url: action, data: {type: type}, success: result => {
            likesBlock
                .find('.like-count').text(result.likes).end()
                .find('.dislike-count').text(result.dislikes).end()
            ;
        }
    });
});
